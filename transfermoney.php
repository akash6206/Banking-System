...
<body style="background-color : #064663;">
<?php
    include 'config.php';
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #e6b31a;" style="border-radius:0%;">Money Transfer</button></a></td> 
                    </tr>
                <?php
                $cnt=$cnt+1;
                    }

<!-- navbar --> 
      <nav class="navbar navbar-expand-md navbar-light bg-light" style="color :RED;">
      <a class="navbar-brand" href="index.php" style="color : #495057;"><img src="img/logo.png" alt="Logo" width="26" style="margin-bottom:4px;"> <b>WOW BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="removeuser.php" style="color : #495057;"><b>View User</b></a>
              </li>
              <li class="nav-item">
